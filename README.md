...
The very first use of the API may require manual intervention by manually navigating using your favorite browser to the URL generated by STR_M1 (see [Program Usage] bellow).  To be honest I’m kind of fuzzy on what magic does what and when.
...
+ -dbgInFile -- Input file for debugging.  Generally used with DBG1 bellow.
